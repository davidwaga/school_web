...
class User(AbstractUser):
    ...
    approval_status = models.CharField(max_length=2,choices=APPROVAL_CHOICES,default='n',)
    employee_or_student_id = models.CharField(max_length=10,blank=True, null=True)
...
class SocialLink(models.Model):
    user_profile = models.ForeignKey('CommonUserProfile',on_delete=models.CASCADE)
...
class CommonUserProfile(models.Model):
    ...
    cover_picture = models.ImageField(upload_to='cover-pictures',blank=True,null=True)
    headline = models.CharField(max_length=255,blank=True,null=True)
    show_headline_in_bio = models.BooleanField(help_text='I want to use this as my bio',default=False)
    summary = RichTextUploadingField(help_text='Your Profile Summary',blank=True,null=True)
    country = CountryField(blank=True,null=True)
    social_links = models.ManyToManyField(SocialLink,related_name='social_links',blank=True
    )
